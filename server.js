...
// 1. Получить предметы для класса
...
// 5. Получить прогресс пользователя (демо)
...
// 7. Инициализация данных (для демо)
...
// Все остальные маршруты перенаправляются на фронтенд
app.get('*', (req, res) => {
